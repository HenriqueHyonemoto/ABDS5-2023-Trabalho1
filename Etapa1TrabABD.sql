...
INSERT INTO cirurgia VALUES (nextval('sid_cirurgia'), 'c1', '25/07/2008', 'Apendicite',
(SELECT id_paciente FROM paciente WHERE nome = 'João'))
RETURNING id_cirurgia;

INSERT INTO cirurgia VALUES (nextval('sid_cirurgia'), 'c2', '07/02/2001', 'Retirada de cálculo renal',
(SELECT id_paciente FROM paciente WHERE nome = 'Maria'))
RETURNING id_cirurgia;

INSERT INTO cirurgia VALUES (nextval('sid_cirurgia'), 'c3', '14/11/2007', 'Unha encravada',
(SELECT id_paciente FROM paciente WHERE nome = 'Pedro'))
RETURNING id_cirurgia;

INSERT INTO cirurgia VALUES (nextval('sid_cirurgia'), 'c4', '23/01/2008', 'Implante de silicone',
(SELECT id_paciente FROM paciente WHERE nome = 'Maria'))
RETURNING id_cirurgia;
